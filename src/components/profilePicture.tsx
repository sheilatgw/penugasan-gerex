...
function ProfilePicture({photo = "img/default-avatar.webp", name, onFileSelect}: PFP) {
  return (
    <label className="relative group size-20 md:size-30 rounded-full border-6 border-white cursor-pointer">
